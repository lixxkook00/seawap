  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'Seaswap Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'Seaswap Collectibles are special ERC-721 NFTs that can be used on the SeaSwap platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved Seaswap Collectibles won't be shown here.",
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{TranslateString(999, 'See all approved Seaswap Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
