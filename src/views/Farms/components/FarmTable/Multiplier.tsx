...
const Multiplier: React.FunctionComponent<MultiplierProps> = ({ multiplier }) => {
  ...
  const tooltipContent = (
    <div>
      {TranslateString(999, 'The multiplier represents the amount of SSG rewards each farm gets.')}
      <br />
      <br />
      {TranslateString(
        999,
        'For example, if a 1x farm was getting 1 SSG per block, a 40x farm would be getting 40 SSG per block.',
      )}
    </div>
  )
